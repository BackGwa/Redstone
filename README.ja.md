...
> [!TIP]
> モデルにプラグイン全体を一度に完成させようとさせないでください。機能を段階的に実装していくほうが、安定性が高く、最も優れた成果につながります。
...
[^3]: Claudeモデルの中では、多くのタスクをSonnet 4.5で成功させることができます。ただし、より大きなコードベースを扱い、より深い理解が必要な場合はOpus 4.6の使用を検討してください。このモデルは利用コストが高いため、Sonnet 4.5とOpus 4.6を交互に使うことを推奨します。
