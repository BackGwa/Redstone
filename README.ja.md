...
[^3]: Claudeモデルの中では、多くのタスクをSonnet 4.6で成功させることができます。ただし、より大きなコードベースを扱い、より深い理解が必要な場合はOpus 4.6の使用を検討してください。このモデルは利用コストが高いため、Sonnet 4.6とOpus 4.6を交互に使うことを推奨します。
